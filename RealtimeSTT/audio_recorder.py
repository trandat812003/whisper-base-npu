...
import re
import gc
from .test_whisper_onnx import transcribe
...
class TranscriptionWorker:
    ...
    def run(self):
        ...
        try:
            ...
            print(warmup_audio_path, warmup_audio_data)
...
class AudioToTextRecorder:
    ...
    def transcribe(self):
        ...
        # self.perform_final_transcription(audio_copy)

        # feats = extract_features(audio_copy)

        # while True:
        #     transcribe(audio_copy)

        return transcribe(audio_copy)
